...
ERROR_MAP = {
    '401': Response('<h1>401 Unknown or unsupported method</h1>', content_type='text/html; charset=UTF-8',
                    status=401),
...
class SYLFK(object):
    ...
    def dispatch_static(self, static_path):
        ...
        static_path = os.path.sep.join(("xin",static_path))
    ...
    def bind_view(self,url,view_class,endpoint):
        self.add_url_rule(url,view_class.get_func(endpoint),func_type='view')
